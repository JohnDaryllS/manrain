...
// Drawing a Woman with  
// an umbrella 
void DrawWomanAndUmbrella(int x, int ldisp) 
{ 
    circle(x, GroundY - 90, 10); 
    line(x, GroundY - 80, x, GroundY - 30); 
    line(x, GroundY - 70, x + 5, GroundY - 55); 
    line(x, GroundY - 70, x - 5, GroundY - 55); 
    line(x + 5, GroundY - 55, x + 10, GroundY - 60); 
    line(x - 5, GroundY - 55, x - 10, GroundY - 60); 
